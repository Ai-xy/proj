...
import 'room_tap_head_detail_model.dart';
export 'room_tap_head_detail_model.dart';

class RoomTapHeadDetailWidget extends StatefulWidget {
  const RoomTapHeadDetailWidget({Key? key}) : super(key: key);

  @override
  _RoomTapHeadDetailWidgetState createState() =>
      _RoomTapHeadDetailWidgetState();
}

class _RoomTapHeadDetailWidgetState extends State<RoomTapHeadDetailWidget> {
  late RoomTapHeadDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RoomTapHeadDetailModel());
  }
